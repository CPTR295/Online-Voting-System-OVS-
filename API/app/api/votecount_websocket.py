...
@current_app.post("/ovs/check/vote/counts/client")
def bulk_check_vote_count():
    ws = Client('ws://127.0.0.1:5000/ovs/check/vote/counts/ws', headers={"Access-Control-Allow-Origin": "*"})
...
@sock.route("/ovs/check/vote/counts/ws")
