...
class ElectionRepository:
    ...
    async def insert_election(self,election:Election)->bool:
        try:
    ...
    async def update_election(self,id:int,details:Dict[str,Any])->bool:
        try:
    ...
    async def delete_election(self,id:int)->bool:
        try:
    ...
    async def select_one_election(self,id:int):
